...
const styles = StyleSheet.create({
  ...
  addressCardActive: { borderColor: colors.green },
  ...
  addAddressBtn: { backgroundColor: colors.greenSoft, borderRadius: radii.md - 2, padding: 16, alignItems: 'center' },
  addAddressText: { fontFamily: fontFamily.bodyBold, color: colors.greenDeep, fontSize: 13 },
  slotChip: { backgroundColor: colors.greenSoft, borderRadius: radii.sm, paddingVertical: 10, paddingHorizontal: 14, alignSelf: 'flex-start' },
  slotChipText: { fontFamily: fontFamily.bodyBold, fontSize: 12.5, color: colors.greenDeep },
