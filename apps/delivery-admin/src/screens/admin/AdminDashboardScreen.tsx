...
const styles = StyleSheet.create({
  ...
  kpiValue: { fontFamily: fontFamily.bodyExtraBold, fontSize: 18, color: colors.greenDeep, marginBottom: 4 },
  ...
  pipelineChip: { backgroundColor: colors.greenSoft, borderRadius: radii.sm, paddingHorizontal: 12, paddingVertical: 8, alignItems: 'center', minWidth: 80 },
  pipelineCount: { fontFamily: fontFamily.bodyExtraBold, fontSize: 15, color: colors.greenDeep },
  pipelineLabel: { fontFamily: fontFamily.bodyMedium, fontSize: 9.5, color: colors.greenDeep, textTransform: 'capitalize' },
