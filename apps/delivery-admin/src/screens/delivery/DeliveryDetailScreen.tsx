...
const styles = StyleSheet.create({
  ...
  callBtn: { marginTop: 12, alignSelf: 'flex-start', backgroundColor: colors.greenSoft, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 8 },
  callBtnText: { fontFamily: fontFamily.bodyBold, fontSize: 12.5, color: colors.greenDeep },
  divider: { height: 1, backgroundColor: colors.border, marginVertical: 10 },
  rowBetween: { flexDirection: 'row', justifyContent: 'space-between' },
  amount: { fontFamily: fontFamily.bodyExtraBold, fontSize: 13, color: colors.greenDeep },
